...
│
├── app-icon/                   # Icon source files (SVG + adaptive PNG layers)
│
├── .github/workflows/
...
App icon source files (SVG and rasterized PNG layers for Android's adaptive icon format) live in `app-icon/` at the project root, matching the bowl-fill visual and lunch/dinner color split used throughout the UI.
